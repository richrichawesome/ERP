...
class Requisition(models.Model):
    ...
    req_type = models.CharField(max_length=30, choices=REQ_TYPE_CHOICES)

    # Main status + sub-status combo
    req_main_status = models.CharField(max_length=40, choices=REQ_MAIN_STATUS_CHOICES, default="Pending Custodian Approval")
    req_substatus = models.CharField(max_length=40, choices=REQ_SUBSTATUS_CHOICES, default="NONE")
    ...
    rfq_pdf = models.FileField(upload_to="rfq/", null=True, blank=True)
