...
class RFQ(models.Model):
    ...
    rfq_created_by = models.ForeignKey(User, on_delete=models.CASCADE)
    def __str__(self):
        # return self.rfq_id
...
class RFQ_Item(models.Model):
    ...
    rfq = models.ForeignKey(RFQ, on_delete=models.CASCADE, related_name="items", null=True, blank=True)

    # The requisition item it came from
    ...
    def __str__(self):
        return f"RFQItem {self.rfq_item_id} - {self.product.prod_name}"
